...
/**
 * Clase que contiene la lógica para resolver el problema de los dados usando backtracking.
 * El problema consiste en encontrar las posibles combinaciones de un número n de dados
 * para que al sumarlos su resultado sea un número b 
 *
 */
public class Dados {
