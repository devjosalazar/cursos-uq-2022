...
public class VentanaHilos extends ApplicationWindow {
	...
	protected Control createContents(Composite parent) {
		...
		Group grpHilosServiciosNo = new Group(container, SWT.NONE);
		grpHilosServiciosNo.setText("Hilos servicios NO propios");
		grpHilosServiciosNo.setBounds(334, 95, 252, 314);
		
		Group grpHiloServicio_3 = new Group(grpHilosServiciosNo, SWT.NONE);
		grpHiloServicio_3.setText("Hilo servicio 4");
		grpHiloServicio_3.setBounds(10, 33, 232, 82);
		
		Button btnStart_3 = new Button(grpHiloServicio_3, SWT.NONE);
		btnStart_3.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				
				manejadorHilo.starHiloServicio4(Integer.valueOf(textValorEntrada.getText()));
				
			}
		});
		btnStart_3.setBounds(10, 32, 75, 25);
		btnStart_3.setText("Start");
		
		textValorEntrada = new Text(grpHiloServicio_3, SWT.BORDER);
		textValorEntrada.setBounds(109, 36, 113, 21);
		
		Group grpHiloServicio_4 = new Group(grpHilosServiciosNo, SWT.NONE);
		grpHiloServicio_4.setText("Hilo servicio 5");
		grpHiloServicio_4.setBounds(20, 130, 222, 60);
		
		Button btnStart_4 = new Button(grpHiloServicio_4, SWT.NONE);
		...
		btnStart_4.setBounds(56, 25, 75, 25);
		btnStart_4.setText("Start");
		
		Button btnStop_3 = new Button(grpHilosServiciosNo, SWT.NONE);
		btnStop_3.setBounds(83, 229, 75, 25);
